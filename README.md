...
- **[ctxgraph](https://github.com/rohansx/ctxgraph)** — Local-first context graph engine for AI agents and human teams.
- **[wardn](https://github.com/rohansx/wardn)** — Credential isolation for AI agents. Agents never see real API keys - structural guarantee, not policy.
- **[reflect](https://github.com/rohansx/reflect)** — Self-correction engine for AI coding agents.
